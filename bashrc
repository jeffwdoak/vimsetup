...
# SSH Aliases
#alias qtalpha='ssh -Y jdoak@192.168.3.40'
alias quest='ssh -Y jwd686@quest.it.northwestern.edu'
...
# Python distribution through anaconda
export PATH=/cygdrive/c/Anaconda:$PATH

# Enthough Python with Scipy
#export PATH=$PATH:/cygdrive/c/Users/jdoak/AppData/Local/Enthought/Canopy/User

# fix non-interactive problems with enthought python
#pythonf() {
#  if [ "$#" -gt "0" ]
#  then
#    python.exe $@  # This may break any script that uses command-line arguments!
#  else
#    python.exe -i
#  fi
#}
